    ...
    var <?= $randomUploadName ?>UploadedCount = 0;
     function <?= $randomUploadName ?>Run() {
        ...
        uploadWithFileDom(document.getElementById('<?= $randomUploadName ?>'), function(fileIndex,  percent) {
            ...
            var src = '<?= \app\services\QiniuService::$domain ?>' + res.key;
            if(is_img) {
...
<div>
    ...
    <div id="<?= $randomUploadName ?>data">
        ...
        foreach ($value as $src){
            ?>
         <div  style="cursor: move;height:250px;width:250px;display: inline-block;" class="panel panel-default"  ondrop="drop(event,this)" ondragover="allowDrop(event)" draggable="true" ondragstart="drag(event, this)" >
            <div class="panel-heading">可拖动交换位置</div>
            <div class="panel-body" style="text-align: center;">
               <?php
               if(\yii\helpers\StringHelper::endsWith($src, 'jpg') ||\yii\helpers\StringHelper::endsWith($src, 'jpeg') ||\yii\helpers\StringHelper::endsWith($src, 'png') ||\yii\helpers\StringHelper::endsWith($src, 'gif') ):
               ?>
                     <a title="点我看源图片" target="_blank" href="<?= $src ?>">
                         <img  style=" height: 150px;width:150px;" src="<?= $src ?>?imageMogr2/format/jpg/thumbnail/150x/blur/1x0/quality/80" />
                         <br> 图片
                      </a>
               <?php
               endif;
            ...
            <?php
            if(\yii\helpers\StringHelper::endsWith($src, 'mp4')  ):
                ?>

                    <a title="点我看源视频" target="_blank" href="<?= $src ?>">
                          <img  style=" height: 150px;width:150px;"  src="<?= $src ?>?vframe/jpg/offset/0/w/150" />
                           <br> MP4视频
                    </a>
           <?php
            else:
            ?>
             ...
             <a  style=" height: 150px;width:150px;" title="点我看源文件" target="_blank" href="<?= $src ?>">
                其他类型文件
              </a>
               <?php
               endif;
               ?>
                ...
                <div class="panel-footer" style="text-align: center;"><a onclick="$(this).parent().parent().remove()">删除</a></div>
            </div>
